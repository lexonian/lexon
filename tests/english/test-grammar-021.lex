...
A "Garply Qux" is a person.

PER Garply Qux:
A "Garply Qux" is this Bar.
A "Garply Qux" is amount.
A "Garply Qux" is an binary.

CLAUSE: Fred.
A "Fred" is has passed neither 123 month after Fred millisecond after person minutes after the amount being equal the then current time nor an data not fixed and 123 lies at the least the Fred, neither this Bar be data or this Bar is no data, neither a time nor Fred past.
