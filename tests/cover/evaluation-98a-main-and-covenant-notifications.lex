...
"Notification Message" is a text.

The Licensor appoints the Arbiter,
fixes the Licensing Fee,
fixes the Notification Message,
and fixes the Breach Fee.

CLAUSE: Test.
THe Licensor may terminate this contract, and notify the Arbiter of the Notification Message.
...
CLAUSE: Commission.
The Licensor may certify this License as Commissioned, and notify the Licensee of ‹Commission›.
