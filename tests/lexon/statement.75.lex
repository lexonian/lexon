...
The Filing Office may, if the Termination Statement is filed, pay the Digital Asset Collateral to the Debtor.

Clause: Release Reminder Service Fee.
The Filing Office may, if the Termination Statement is filed, pay the Reminder Service Fee to the Secured Party.
